...
function getEventById(id: StringOrNumber): Event | null {
  return events.filter(e => Number(e.id) === Number(id))[0];
}
...
const getEventDetails = (eventId: StringOrNumber): string => {
